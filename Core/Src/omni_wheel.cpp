...
float wheel::motor_main(float direction, int power, float mod){
    double Motor[4];//PWMvalue
    ...
    double scope = max(abs_m1,abs_m2);//max power caluculate
